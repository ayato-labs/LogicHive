...
async def reindex_all():
    logger.info("Starting Batch Re-indexing V3 (Fixed UNIQUE Constraint)...")
    ...
    for org_id in org_ids:
        ...
        for func in functions:
            ...
            try:
                ...
                if success:
                    logger.info(f"     [Done] {name} re-indexed and SAVED.")
                else:
    ...
    logger.info("Batch Re-indexing V3 completed.")
